...
import SpringCSV.service.CSVService;
		...
		if(CSVHelper.hasCSVFormat(file)) {
			try {
				...
				String fileDownloadUri = ServletUriComponentsBuilder.fromCurrentContextPath().
													...
													.toUriString();
				return ResponseEntity.status(HttpStatus.OK).body(new ResponeMessage(message,fileDownloadUri));		
			}catch(Exception e) {
